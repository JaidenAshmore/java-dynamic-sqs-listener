...
/**
 * Processor that has the responsibility of handling the tasks of taking a message and getting it processed by the
 * message consumer.
 *
 * <p>This would therefore know what message consumer (method) should be executed for this message and how to execute it.
