...
public class QueueListenerAutoConfigurationTest {
    ...
    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(QueueListenerAutoConfiguration.class));
        ...
        this.contextRunner
                ...
                .run((context) -> {
                    ...
                    assertThat(context.getBean(SqsAsyncClient.class)).isSameAs(
                            context.getBean(QueueListenerAutoConfiguration.class).sqsAsyncClient());
                });
    }
        ...
        this.contextRunner
                ...
                .run((context) -> {
                    ...
                    assertThat(context.getBean(PayloadMapper.class)).isSameAs(
                            context.getBean(QueueListenerAutoConfiguration.ArgumentResolutionAutoConfiguration.CoreArgumentResolversConfiguration.class)
                                    .payloadMapper());
                });
    }
