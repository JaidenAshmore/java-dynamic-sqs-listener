...
@Slf4j
@SpringBootTest(classes = {Application.class, BatchingQueueListenerEnvironmentIntegrationTest.TestConfig.class}, webEnvironment = RANDOM_PORT)
@RunWith(SpringRunner.class)
@TestPropertySource(properties = {
        "prop.concurrency=5"
})
public class BatchingQueueListenerEnvironmentIntegrationTest {
    private static final String QUEUE_NAME = "BatchingQueueListenerEnvironmentIntegrationTest";
    ...
    public static class TestConfig {
        ...
        public static class MessageListener {
            @BatchingQueueListener(value = QUEUE_NAME, concurrencyLevelString = "${prop.concurrency}")
