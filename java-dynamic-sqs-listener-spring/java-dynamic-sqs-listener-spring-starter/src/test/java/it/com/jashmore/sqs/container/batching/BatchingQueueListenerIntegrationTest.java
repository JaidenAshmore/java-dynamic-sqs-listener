...
@Slf4j
@SpringBootTest(classes = {Application.class, BatchingQueueListenerIntegrationTest.TestConfig.class}, webEnvironment = RANDOM_PORT)
@RunWith(SpringRunner.class)
public class BatchingQueueListenerIntegrationTest {
    private static final String QUEUE_NAME = "BatchingQueueListenerIntegrationTest";
