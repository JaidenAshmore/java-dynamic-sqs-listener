 ...
 */
public class FifoQueueListenerParser {

    private final PlaceholderResolver placeholderResolver;

    public FifoQueueListenerParser(final PlaceholderResolver placeholderResolver) {
    ...
    protected Supplier<Integer> maximumMessagesInGroupSupplier(final FifoQueueListener annotation) {
        ...
        if (!StringUtils.hasText(annotation.maximumMessagesInMessageGroupString())) {
            ...
            batchSize = Integer.parseInt(placeholderResolver.resolvePlaceholders(annotation.maximumMessagesInMessageGroupString()));
        }
