...
class AutoVisibilityExtenderMessageProcessingDecoratorFactoryTest {
    ...
    @BeforeEach
    void setUp() {
        factory = new AutoVisibilityExtenderMessageProcessingDecoratorFactory(placeholderResolver);
    }
    ...
    class BuildConfigurationProperties {
        ...
        void shouldBeAbleToBuildPropertiesFromStrings() {
            // arrange
            when(placeholderResolver.resolvePlaceholders(anyString())).thenAnswer(invocation -> invocation.getArgument(0));
