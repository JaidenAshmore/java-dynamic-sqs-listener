...
class QueueListenerAnnotationTransformerTest {

    @Mock
    private VisitorContext visitorContext;

    private QueueListenerAnnotationTransformer transformer;

    @BeforeEach
    void setUp() {
        transformer = new QueueListenerAnnotationTransformer();
    }

    @Test
    void testGetName() {
        String expectedName = "com.jashmore.sqs.annotations.core.basic.QueueListener";
    ...
    @Test
    void testTransform() {
        AnnotationValue<Annotation> annotationValue = AnnotationValue.builder("QueueListener").member("concurrencyLevel", 5).build();
