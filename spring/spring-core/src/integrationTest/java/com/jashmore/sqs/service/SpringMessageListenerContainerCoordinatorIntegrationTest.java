...
@Slf4j
@SpringBootTest(classes = { SpringMessageListenerContainerCoordinatorIntegrationTest.TestConfig.class, QueueListenerConfiguration.class })
@ExtendWith(SpringExtension.class)
public class SpringMessageListenerContainerCoordinatorIntegrationTest {
