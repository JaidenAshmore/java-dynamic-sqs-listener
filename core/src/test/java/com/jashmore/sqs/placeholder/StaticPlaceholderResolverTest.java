...
class StaticPlaceholderResolverTest {
    ...
    void resettingPlaceholdersWillClearMapping() {
        ...
        assertThat(placeholderResolver.resolvePlaceholders("from something"))
                .isEqualTo("from something");
    }
    ...
    void canChangePlaceholderReplacements() {
        ...
        assertThat(placeholderResolver.resolvePlaceholders("first for us"))
                .isEqualTo("fourth word for us");
    }
}