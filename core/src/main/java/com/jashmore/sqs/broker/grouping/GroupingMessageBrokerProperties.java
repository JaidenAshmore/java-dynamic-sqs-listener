...
public interface GroupingMessageBrokerProperties {
     ...
     *         implementation details of the {@link GroupingMessageBroker} it will request as many messages as the concurrency level and will wait until
     ...
     *
     * <p>If this duration is null or negative, {@link GroupingMessageBrokerConstants#DEFAULT_CONCURRENCY_POLLING} will be used instead. It is not
     ...
     * difficult to debug.
     *
     * <p>If this value is null or negative, {@link GroupingMessageBrokerConstants#DEFAULT_BACKOFF_TIME} will be used as the backoff period.
     *
    ...
    @Min(1)
    int getMaximumConcurrentMessageRetrieval();

    String groupMessage(Message message);
}
