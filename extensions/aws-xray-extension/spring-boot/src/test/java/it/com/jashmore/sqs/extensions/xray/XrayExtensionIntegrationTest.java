package it.com.jashmore.sqs.extensions.xray;
...
@SpringBootTest(classes = {
        XrayExtensionIntegrationTest.TestConfig.class,
        SqsListenerXrayConfiguration.class,
...
public class XrayExtensionIntegrationTest {
    ...
    @Test
    void willSendSegmentAndSubsegmentForMessageListener() throws InterruptedException, SocketException, TimeoutException, ExecutionException {
        // arrange
