...
class BasicXrayMessageProcessingDecoratorTest {
    ...
    public class MessageListenerSegment {
        ...
        void willContinueTraceWhenHeaderPresentInMessage() {
            ...
            // act
            processor.processMessage(Message.builder()
    ...
    private MessageProcessor createMessageProcessor(final String messageListenerIdentifier,
