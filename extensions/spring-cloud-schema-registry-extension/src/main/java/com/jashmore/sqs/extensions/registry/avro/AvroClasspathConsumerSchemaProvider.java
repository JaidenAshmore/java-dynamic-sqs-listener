 ...
 */
public class AvroClasspathConsumerSchemaProvider implements ConsumerSchemaProvider<Schema> {
    private final Map<Class<?>, Schema> classSchemaMap;

    public AvroClasspathConsumerSchemaProvider(final List<Resource> schemaImports,
